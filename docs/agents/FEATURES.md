...
| Auth / session | `src/app/login/page.tsx`, `signup` | `src/app/api/login`, `signup`, `logout`, `session`, `account/password`, `auth/google` | `src/app/api/authMiddleware.ts`, `src/app/lib/use-session.tsx`, `session-version.ts`, `src/app/lib/google-oauth.ts` | `src/middleware.test.ts`, `session-version.test.ts`, `src/app/api/authMiddleware.test.ts`, `src/app/api/session/route.test.ts`, `src/app/api/signup/route.test.ts`, `src/app/api/logout/route.test.ts`, `src/app/api/logout/all/route.test.ts`, `src/app/api/account/password/route.test.ts`, `src/app/lib/google-oauth.test.ts`, `src/app/api/auth/google/route.test.ts`, `src/app/api/auth/google/callback/route.test.ts` | — |
