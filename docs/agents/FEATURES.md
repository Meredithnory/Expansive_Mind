...
| Search | `src/app/searchpaper/page.tsx` | `src/app/api/search/route.ts` → `research/registry.ts` | `src/app/lib/search-suggest.ts`, `paper-sources.ts` | `src/app/api/search/springer-query.test.ts`, `src/app/api/search/route.test.ts`, `src/app/api/search/suggest/route.test.ts`, `src/app/lib/search-suggest.test.ts` | `SearchPaperClient.tsx`, `search/utils.ts` |
...
| Share / brief | `src/app/brief/[slug]/page.tsx` | `src/app/api/discover/share/route.ts`, `src/app/api/brief/route.ts` | `src/app/lib/share-slug.ts`, `shared-brief.ts`, `quote-eligibility.ts`, `src/app/api/discover/claim-ledger.ts` | `src/app/api/discover/share/route.test.ts`, `src/app/api/discover/share/route-gates.test.ts`, `src/app/api/discover/claim-ledger.test.ts`, `src/app/lib/quote-eligibility.test.ts`, `src/app/lib/share-slug.test.ts`, `src/app/lib/shared-brief.test.ts`, `src/app/api/brief/route.test.ts` | — |
| Auth / session | `src/app/login/page.tsx`, `signup`, `src/app/forgot-password/page.tsx`, `src/app/reset-password/page.tsx` | `src/app/api/login`, `signup`, `logout`, `session`, `account/password`, `src/app/api/password-reset/route.ts`, `src/app/api/password-reset/confirm/route.ts` | `src/app/api/authMiddleware.ts`, `src/app/lib/use-session.tsx`, `session-version.ts`, `src/app/lib/password-reset.ts`, `src/app/lib/password-reset-mail.ts` | `src/middleware.test.ts`, `session-version.test.ts`, `src/app/api/authMiddleware.test.ts`, `src/app/api/session/route.test.ts`, `src/app/api/signup/route.test.ts`, `src/app/api/logout/route.test.ts`, `src/app/api/logout/all/route.test.ts`, `src/app/api/account/password/route.test.ts`, `src/app/lib/password-reset.test.ts`, `src/app/lib/password-reset-mail.test.ts`, `src/app/api/password-reset/route.test.ts`, `src/app/api/password-reset/confirm/route.test.ts` | — |
...
| Site chrome | `src/app/layout.tsx` → `NavBar` (`Title` beta chip) + `Footer` | — | `src/app/components/site-status.ts` | `src/app/components/site-status.test.ts`, `src/app/components/chrome-stacking.test.ts` | `NavBar.tsx` homepage spacer; `--mobile-bottom-nav-clearance`; Discover islands |
